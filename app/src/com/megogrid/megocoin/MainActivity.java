...
import com.megogrid.megocoin.db.ImageDetail;
import com.megogrid.megocoin.db.SavedDbHelper;
import com.megogrid.megocoin.dialog.BoxIDConstant;
import com.megogrid.megocoin.share.GalleryAlbumActivity;
import com.megogrid.megocoin.share.Help;
...
public class MainActivity extends Activity {
    ...
    com.megogrid.megocoin.CustomDrawerLayout drawer_layout;
...
//    MeUser meUser;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        drawer_layout = (com.megogrid.megocoin.CustomDrawerLayout) findViewById(R.id.drawer_layout1);
...
//        Configuration = (TextView) findViewById(R.id.Configuration);
       ...
       /* Configuration.setOnClickListener(new OnClickListener() {
        ...
        deleteFeature.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                iabManager.deleteApp(MainActivity.this);
            }
        });
